...
namespace Fruitables.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(Category category)
        {
            ...
            if (result)
            {
                ModelState.AddModelError(nameof(Category.Name), $"{category.Name} is already exists");
                return View();
            }
        ...
        public async Task<IActionResult> Update(Category category, int? id)
        {
            ...
            bool result = await _context.Products.AnyAsync(c => c.Name == category.Name && c.Id != id);
